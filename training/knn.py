...
MODEL_DIR = '../model/knn/' # Diubah ke folder knn
MODEL_PATH = os.path.join(MODEL_DIR, 'knn_model.pkl') # Diubah ke model knn
...
def train_and_evaluate_model():
    """
    Fungsi ini memuat data, melatih model KNN, mengevaluasinya,
    ...
    # 6. Latih model KNN (diganti dari Decision Tree)
...
st.set_page_config(page_title="Analisis Sentimen KNN", layout="centered")
st.title("Analisis Sentimen Komentar Film dengan KNN")
