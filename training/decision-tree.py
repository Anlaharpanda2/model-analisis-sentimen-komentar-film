...
def train_and_evaluate_model():
    """
    Fungsi ini memuat data, melatih model Decision Tree, mengevaluasinya,
...
st.set_page_config(page_title="Analisis Sentimen DT", layout="centered")
st.title("Analisis Sentimen Komentar Film dengan Decision Tree")
